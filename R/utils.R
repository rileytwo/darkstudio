...
# 2020-05-21
#
find_index_file <- function(override = FALSE, ...) {
  if (override == TRUE) {
    # Allow user to override the returned location by providing the path
    # of index.htm
    rstudio_index <- unlist(list(...))
    ...
    rstudio_index <- check_paths(p = paths)
  }
